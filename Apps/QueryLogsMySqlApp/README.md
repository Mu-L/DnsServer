...
A DNS App for Technitium DNS Server that logs DNS queries to a MySQL/MariaDB database.
...
2. A background consumer thread bulk inserts records into MySQL/MariaDB storage.
